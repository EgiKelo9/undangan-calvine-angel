  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-w-5xl w-full mx-auto gap-6 sm:gap-8 md:gap-10 lg:gap-12 text-center py-6">
        ...
        {/* Greeting */}
        <ScrollReveal animation="fade-in-up" delay={200} className="flex flex-col items-center justify-center space-y-2 sm:space-y-4">
        ...
        {/* Pawiwahan */}
        <div className="flex flex-col w-full items-center justify-center gap-8 lg:gap-12">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 items-center md:items-start gap-4 md:gap-8">
            ...
            <ScrollReveal animation="fade-in-up" delay={300} className="col-span-1 justify-self-center text-center md:text-left flex flex-col items-center md:items-start gap-2 md:gap-4">
              <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-serif text-foreground drop-shadow-[0_4px_16px_rgba(255,255,255,0.9)] leading-tight sm:leading-none">
                {couple.groom.label}
              </h4>
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-serif font-semibold text-bali-bronze drop-shadow-sm">
                {couple.groom.fullName}
              </p>
              <p className="flex flex-col gap-1 items-center md:items-start text-sm lg:text-base font-sans drop-shadow-sm">
              ...
              <p className="flex flex-col gap-2 items-center md:items-start text-sm lg:text-base font-sans text-foreground/90 drop-shadow-sm text-center md:text-left">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 items-center md:items-start gap-4 md:gap-8">
            ...
            <ScrollReveal animation="fade-in-up" delay={300} className="col-span-1 md:order-1 justify-self-center text-center md:text-right flex flex-col items-center md:items-end gap-2 md:gap-4">
              ...
              <p className="flex flex-col gap-1 items-center md:items-end text-sm lg:text-base font-sans drop-shadow-sm">
              ...
              <p className="flex flex-col gap-2 items-center md:items-end text-sm lg:text-base font-sans text-foreground/90 drop-shadow-sm text-center md:text-right">
        ...
        <div className="flex flex-col w-full items-center justify-center gap-8 lg:gap-12">
          ...
          <ScrollReveal animation="fade-in-up" delay={200} className="w-full">
            <div className="flex flex-col gap-4 items-center w-full bg-bali-sand backdrop-blur-md border border-bali-gold/30 rounded-2xl py-6 sm:py-8 px-2 shadow-2xl hover:border-bali-gold/50 transition-all duration-300">
              <div className="w-8 sm:w-12 md:w-16 lg:w-20 drop-shadow-xl">
              {/* <div className="w-full drop-shadow-xl place-self-center"> */}
                <div className="animate-float">
                  <Image
                    ...
                    priority
                    className="w-full h-auto object-contain filter drop-shadow-md"
                    // className="h-8 sm:h-12 md:h-16 lg:h-20 w-full object-contain filter drop-shadow-md place-self-center mb-4"
                  />
                </div>
              </div>
              <p className="flex flex-col gap-1 md:gap-2 items-center text-base sm:text-lg md:text-2xl lg:text-3xl font-serif font-semibold text-bali-bronze drop-shadow-sm">
